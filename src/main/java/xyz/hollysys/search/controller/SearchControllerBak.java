...
@Controller
public class SearchControllerBak {
	private static final Logger logger = Logger.getLogger(SearchControllerBak.class);
	@Autowired
...
//	public @ResponseBody ApiResult searchMain(@PathVariable String username, @RequestParam(value="q1", required=false) String query){
		public @ResponseBody ApiResult testMain(@PathVariable String username,
				@RequestHeader(value="Accept") String accept,
				@RequestHeader(value="Accept-Language") String acceptLanguage,
				@RequestHeader(value="User-Agent", defaultValue="foo") String userAgent,
				@RequestHeader(value="content-type", defaultValue="foo") String contenttype,
		...
		//		@RequestBody RegisterUser user,
				@CookieValue(value = "foo", defaultValue = "hello") String fooCookie,
				@CookieValue(value = "JSESSIONID",defaultValue="null") String session,
				HttpServletResponse response){
		StringBuilder sb = new StringBuilder();
		logger.debug("================ header ================");
		logger.debug("accept : " + accept);
